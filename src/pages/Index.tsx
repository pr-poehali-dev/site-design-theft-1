...
const modalData = [
  {
    id: 1,
    title: 'Зарубежные\neSIM',
    description: 'Виртуальные номера для регистрации в любых сервисах',
  ...
  },
  {
    id: 2,
    title: 'Популярные\nсервисы',
    description: 'ChatGPT, Spotify, YouTube Premium, Apple Music и другие',
    image: 'https://cdn.poehali.dev/files/29cdfb46-e1bd-4000-aa59-81069292b460.png',
    buttonText: 'СМОТРЕТЬ СЕРВИСЫ',
    bgColor: 'bg-gradient-to-b from-green-500/30 to-green-700/20',
  },
  {
    id: 3,
    title: 'Разработка\nсайтов',
    description: 'Создайте свой сайт за минуты — без кода, на русском языке',
    ...
    bgColor: 'bg-gradient-to-b from-purple-600/40 to-purple-800/30',
  },
  {
    id: 4,
    title: 'Зарубежная\nкарта',
    description: 'Виртуальная карта для оплаты любых зарубежных сервисов',
